...
// * load the routes module to register app's routes
    ...
    var publicFolderPath = path.join(this.path, "public"),
        hasPublicFolder = fs.existsSync(publicFolderPath);
