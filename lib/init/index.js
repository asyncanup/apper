...
// * load the routes module to register app's routes
    ...
    var apperConfigPath = path.join(this.path, "apper.json"),
        hasApperConfig = fs.existsSync(apperConfigPath);

    if (!(envModulePath || middlewarePath || routesModulePath || hasStaticContent || hasApperConfig)) {
